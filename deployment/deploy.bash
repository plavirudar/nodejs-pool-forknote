...
cd ~
git clone https://github.com/Bathmat/nodejs-pool.git  # Change this depending on how the deployment goes.
cd /usr/src/gtest
sudo cmake .
sudo make
...
cd ~
git clone https://github.com/Bathmat/poolui-forknote.git poolui
cd poolui
npm install
