...
cd ~
git clone https://github.com/plavirudar/nodejs-pool-forknote.git nodejs-pool # Change this depending on how the deployment goes.
cd /usr/src/gtest
sudo cmake .
sudo make
...
cd ~
git clone https://github.com/plavirudar/poolui-forknote.git poolui
cd poolui
npm install
